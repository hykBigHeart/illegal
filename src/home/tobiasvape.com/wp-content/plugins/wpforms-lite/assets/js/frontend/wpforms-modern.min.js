    ...
    const i = {
        ...
        initButtonStyle() {
            o(".wpforms-block.wpforms-container-full, .elementor-widget-wpforms .wpforms-container-full").each(function() {
                ...
                i.isTransparentColor(e) && r.find("button.wpforms-submit").addClass("wpforms-opacity-hover")
            })
        },
        ...
        combinedUploadsSizeError(r, e, o) {
            var t = e.data("formid"),
                a = e.attr("aria-errormessage") || "",
                t = `wpforms-${t}-footer-error`,
                s = e.find(".wpforms-submit");
            e.attr({
                "aria-invalid": "true",
                ...
                role: "alert",
                id: t
            }), o.find("> .wpforms-hidden:first-child").remove(), o.prepend(`<span class="wpforms-hidden">${wpforms_settings.formErrorMessagePrefix}</span>`), s.attr("aria-describedby", t)
        },
        ...
        pageChange(r, o, t) {
            ...
            if (wpforms_settings.indicatorStepsPattern && a.length) {
                ...
                let r = wpforms_settings.indicatorStepsPattern,
                    e;
                r = r.replace("{current}", o).replace("{total}", t), e = a.hasClass("progress") ? a.find(".wpforms-page-indicator-page-title").data(`page-${o}-title`) : a.find(`.wpforms-page-indicator-page-${o} .wpforms-page-indicator-page-title`).text(), r = e ? e + ". " + r : r, a.attr("aria-valuenow", o), i.screenReaderAnnounce(r, "polite")
            }
        },
        ...
        getColorWithOpacity(r, e) {
            ...
            if (!o) return r;
            e = e && 0 !== e.length ? e.toString() : "1";
            r = 4 === o.length ? parseFloat(o[3]) : 1, e = parseFloat(e) * r;
            return `rgba(${o[0]},${o[1]},${o[2]},${e})`.replace(/\s+/g, "")
        },
        getSolidColor(r) {
            r = r.trim();
        ...
        isValidColor(r) {
            ...
            return e.color = r, "" !== e.color
        },
        getColorAsRGBArray(r) {
            if (!i.isValidColor(r)) return !1;
            r = "transparent" === (r = r.replace(/^#/, "").replaceAll(" ", "")) ? "rgba(0,0,0,0)" : r;
            let e;
            return r.match(/[0-9a-f]{6,8}$/gi) ? (e = r.match(/\w\w/g).map(r => parseInt(r, 16)))[3] = e[3] || 0 === e[3] ? (e[3] / 255).toFixed(2) : 1 : e = r.split("(")[1].split(")")[0].split(","), e
        },
        getCssVar(r, e) {
        ...
        getCssVars(r) {
            ...
            var r = r.hasClass("wpforms-container") ? r : r.closest(".wpforms-container"),
                ...
                t = {};
            for (let r = 0; r < o.length; r++) t[o[r]] = i.getCssVar(e, "--wpforms-" + o[r]);
            return t
        }
    };
    return i
