(() => {
            ...
            561: function(e) {
                e.exports = function() {
                    ...
                    var O = u(["a", "abbr", "acronym", "address", "area", "article", "aside", "audio", "b", "bdi", "bdo", "big", "blink", "blockquote", "body", "br", "button", "canvas", "caption", "center", "cite", "code", "col", "colgroup", "content", "data", "datalist", "dd", "decorator", "del", "details", "dfn", "dialog", "dir", "div", "dl", "dt", "element", "em", "fieldset", "figcaption", "figure", "font", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "head", "header", "hgroup", "hr", "html", "i", "img", "input", "ins", "kbd", "label", "legend", "li", "main", "map", "mark", "marquee", "menu", "menuitem", "meter", "nav", "nobr", "ol", "optgroup", "option", "output", "p", "picture", "pre", "progress", "q", "rp", "rt", "ruby", "s", "samp", "section", "select", "shadow", "small", "source", "spacer", "span", "strike", "strong", "style", "sub", "summary", "sup", "table", "tbody", "td", "template", "textarea", "tfoot", "th", "thead", "time", "tr", "track", "tt", "u", "ul", "var", "video", "wbr"]),
                        ...
                        P = u(["math", "menclose", "merror", "mfenced", "mfrac", "mglyph", "mi", "mlabeledtr", "mmultiscripts", "mn", "mo", "mover", "mpadded", "mphantom", "mroot", "mrow", "ms", "mspace", "msqrt", "mstyle", "msub", "msup", "msubsup", "mtable", "mtd", "mtext", "mtr", "munder", "munderover"]),
                    ...
                    return function t() {
                        ...
                        var yt = function(e) {
                            ...
                            Ct = function(e) {
                                ...
                                return e && n && i.insertBefore(a.createTextNode(n), i.childNodes[0] || null), rt === nt ? de.call(t, Fe ? "html" : "body")[0] : Fe ? t.documentElement : i
                            },
                            Et = function(e) {
                            ...
                            St = function(e) {
                                ...
                                }(e) ? (yt(e), !0) : "noscript" !== r && "noembed" !== r && "noframes" !== r || !A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (Pe && 3 === e.nodeType && (t = e.textContent, t = S(t, ye, " "), t = S(t, ve, " "), t = S(t, Ce, " "), e.textContent !== t && (C(o.removed, {
                                    element: e.cloneNode()
                        ...
                        return o.sanitize = function(t) {
                            ...
                            if ($e || dt(p), o.removed = [], "string" == typeof t && (We = !1), We) {
                                ...
                                if (!Ue && !Pe && !Fe && -1 === t.indexOf("<")) return ie && Ve ? ie.createHTML(t) : t;
                            ...
                            return Fe && xe["!doctype"] && r.ownerDocument && r.ownerDocument.doctype && r.ownerDocument.doctype.name && A(X, r.ownerDocument.doctype.name) && (h = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + h), Pe && (h = S(h, ye, " "), h = S(h, ve, " "), h = S(h, Ce, " ")), ie && Ve ? ie.createHTML(h) : h
    ...
    (() => {
        ...
        n.r(r), n.d(r, {
            ...
            TotalsTaxes: () => R,
            TotalsWrapper: () => _,
            ValidatedTextInput: () => vn,
            ValidatedTextInputHandle: () => t.ValidatedTextInputHandle,
            ValidationInputError: () => ln,
            __experimentalApplyCheckoutFilter: () => kn,
            __experimentalRegisterCheckoutFilters: () => Sn,
            applyCheckoutFilter: () => Tn,
            createSlotFill: () => ae,
            extensionCartUpdate: () => gn,
            getRegisteredBlocks: () => Ln,
            ...
            isPostcode: () => fn,
            mustContain: () => cn,
            productPriceValidation: () => hn,
            registerCheckoutBlock: () => Dn,
            registerCheckoutFilters: () => wn,
            useSlot: () => ie
        });
        var e = {};
        n.r(e);
        ...
        let ie;
        ie = "function" == typeof e.useSlot ? e.useSlot : P;
        const ae = (e, t = null) => {
                const {
                    Fill: n,
                    Slot: r
                } = function(e) {
                    const t = t => (0, l.createElement)(q, F({
                        name: e
                    }, t));
                    t.displayName = e + "Fill";
                    const n = t => (0, l.createElement)(Q, F({
                        name: e
                    }, t));
        ...
        const Ue = (0, l.forwardRef)((({
            ...
            o = D || o, (0, l.useLayoutEffect)((() => {
                if (D) return Be(R.current, "is-without-arrow", o), Be(R.current, "is-alternate", i), Fe(R.current, "data-x-axis"), Fe(R.current, "data-y-axis"), $e(R.current, "top"), $e(R.current, "left"), $e(k.current, "maxHeight"), void $e(k.current, "maxWidth");
                const e = () => {
                    ...
                    "number" == typeof f && "number" == typeof h && ($e(R.current, "top", f + "px"), $e(R.current, "left", h + "px")), Be(R.current, "is-without-arrow", o || "center" === g && "middle" === y), Be(R.current, "is-alternate", i), Fe(R.current, "data-x-axis", g), Fe(R.current, "data-y-axis", y), $e(k.current, "maxHeight", "number" == typeof C ? C + "px" : ""), $e(k.current, "maxWidth", "number" == typeof E ? E + "px" : ""), O(({
                        left: "right",
                        right: "left"
                    }[g] || "center") + " " + ({
                        top: "bottom",
        ...
        const He = Ue,
            ...
            ze = function({
                ...
                return (0, l.createElement)("span", F({
                    className: r
                }, n))
            },
            Ye = function({
                ...
                if ("string" == typeof e) return (0, l.createElement)(ze, F({
                    icon: e
                }, n));
        ...
        const pn = new Map([
            ...
            hn = e => cn(e, "<price/>"),
            gn = ((0, A.__)("Unable to get cart data from the API.", "woocommerce"), e => {
                const {
            ...
            yn = (0, l.forwardRef)((({
                ...
                const [E, b] = (0, l.useState)(!0), w = pt(p), S = (0, l.useRef)(null), N = (0, W.useInstanceId)(yn, "", y), x = void 0 !== t ? t : "textinput-" + N, A = void 0 !== i ? i : x, {
        ...
        const wn = (e, t) => {
            ...
            An = (e, t) => !(!nn(e) || !nn(t)) || rn(e) && rn(t) && Object.keys(e).length === Object.keys(t).length && Object.keys(e).every((n => {
            ...
            Tn = ({
                ...
                if (!((e, t, n, r) => {
                        const o = Nn[e];
                        if (!o) return xn(e, t, n, r), !0;
                        const {
                            arg: i = {},
                            extensions: a = {},
                            defaultValue: s = null
                        } = o;
                        return An(t, i) ? !(r === s && An(n, a) || (xn(e, t, n, r), 0)) : (xn(e, t, n, r), !0)
                    })(e, r, n, t) && void 0 !== bn[e]) return bn[e];
                const i = (e => Object.keys(En).map((t => En[t][e])).filter(Boolean))(e);
                let a = t;
                return i.forEach((e => {
                    try {
                        const t = e(a, n || {}, r);
        ...
        const Mn = {},
            On = e => Object.values(Rn).includes(e),
            Ln = e => On(e) ? Object.values(Mn).filter((({
                metadata: t
            }) => ((null == t ? void 0 : t.parent) || []).includes(e))) : [],
            In = window.wc.wcBlocksRegistry,
            Dn = e => {
                var t, n, r, o;
                ((e, t, n) => {
                    if (!rn(e)) return;
                    ...
                    if ("string" == typeof e && !On(e)) throw new Error("When registering a checkout block, the parent must be a valid inner block area.");
                    if (Array.isArray(e) && !e.some((e => On(e)))) throw new Error("When registering a checkout block, the parent must be a valid inner block area.")
                ...
                })(e, "component"), (0, In.registerBlockComponent)({
